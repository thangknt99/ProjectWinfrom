    ...
    public partial class frmBaoCaoThongKe : Form
    {
        ...
        private void frmBaoCaoThongKe_Load(object sender, EventArgs e)
        {
            ...
            if (luuSLMuon != null)
            {
                ...
                luuSLCon = Convert.ToInt32(luuSLCuon) - Convert.ToInt32(luuSLMuon);
            }
            else
            {
                txtSLMuon.Text = luuSLMuon;
                luuSLCon = Convert.ToInt32(luuSLCuon) - 0;
            }
        ...
        {
            frmReportViewerBaoCaoThongKe frm = new frmReportViewerBaoCaoThongKe();
            frm.ShowDialog();
        }
