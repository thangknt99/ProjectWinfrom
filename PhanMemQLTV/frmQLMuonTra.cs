...
namespace PhanMemQLTV
{
    public partial class frmQLMuonTra : Form
    {
        ...
        private void txtSLMuon0_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void btnInmuonsach_Click(object sender, EventArgs e)
        {
            frmReportReviewHDMuonSach frm = new frmReportReviewHDMuonSach();
            frm.ShowDialog();
        }
        ...
        private void muonSach()
        {
            ...
            if (txtSLMuon0.Text.Length > 0 && cboMaDG0.Text.Length > 0 && cboMaSach0.Text.Length > 0)
            {
                if (luuSLMuon <= luuSLCon)
                {
                    ...
                    {
                        MessageBox.Show("Không thể mượn.\nSố sách bạn mượn quá 3cuốn", "Thông Báo");
                        txtSLMuon0.Text = "";
                        txtSLMuon0.Focus();
                    }
